...
// Everything here ships unguarded. The /admin prefix is the point: authentication,
// when it lands, is one middleware on one subtree rather than a per-route audit
// (spec E §4).
const TAGS = ['Admin'];
