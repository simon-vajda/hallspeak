 ...
 * build substitutes the literal and drops both the call and its message. Errors are not
 * gated: an operation that failed in a way that degrades what the person gets is worth a line
 * wherever it happens.
 *
