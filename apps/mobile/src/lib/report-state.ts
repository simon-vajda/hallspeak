import { REPORT_CATEGORIES, type ReportCategory, reportAgeLabel } from '@/lib/reports';

// Copied from `apps/web/src/components/guest/report-state.ts` with its specifier repointed
// at this package's alias. It is pure, and it travels with `reports.ts`, which it imports.
